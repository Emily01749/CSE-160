  ...
  document.getElementById('art').addEventListener('mouseup', function() {
    ...
    */
    ...
    let drawingPts = [
      ...
      [[2018, 1650], [1727, 2205], [2233, 1622], [1.0, 1.0, 1.0, 1.0]], // Tail 1
      [[1259, 1754], [891, 1457], [896, 1881], [1.0, 1.0, 1.0, 1.0]], // Tail 2 (first part)
      [[891, 1457], [302, 1996], [885, 1908], [1.0, 1.0, 1.0, 1.0]], // Tail 2 (2nd part)
      [[1771, 1408], [1859, 1325], [1875, 1435], [1.0, 1.0, 1.0, 1.0]], // "E" (1)
      [[1875, 1325], [1974, 1380], [1870, 1424], [1.0, 1.0, 1.0, 1.0]], // "E" (2)
      [[1864, 1325], [1969, 1380], [1864, 1325], [1.0, 1.0, 1.0, 1.0]], // "E" (3)
      [[1870, 1331], [1974, 1237], [1853, 1215], [1.0, 1.0, 1.0, 1.0]], // "E" (4)
      [[1859, 1204], [1853, 1111], [1969, 1171], [1.0, 1.0, 1.0, 1.0]], // "E" (5)
      [[1980, 1402], [2084, 1325], [2101, 1408], [1.0, 1.0, 1.0, 1.0]], // "M" (1)
      [[2101, 1320], [2183, 1182], [2189, 1325], [1.0, 1.0, 1.0, 1.0]], // "M" (2)
      [[2189, 1204], [2183, 1325], [2304, 1320], [1.0, 1.0, 1.0, 1.0]], // "M" (3)
      [[2233, 1325], [2304, 1314], [2326, 1419], [1.0, 1.0, 1.0, 1.0]], // "M" (4)
      [[2348, 1309], [2409, 1210], [2442, 1314], [1.0, 1.0, 1.0, 1.0]], // "M" (5)
      [[2343, 1336], [2442, 1446], [2442, 1320], [1.0, 1.0, 1.0, 1.0]], // "M" (6)
    ]
